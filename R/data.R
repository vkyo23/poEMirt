...
#' @title Simulated data (dynamic and repeated items)
#' @format A tbl_df with 200 individuals, 400 items (10 repeated items), 40 time-periods (10 items per time-period), and max(K_j) = 5. 
#'  \describe{
#'   \item{i}{Individual ID}
#'   \item{j}{Item ID}
#'   \item{t}{Time-period}
