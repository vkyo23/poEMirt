...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double& >::type tol(tolSEXP);
    Rcpp::traits::input_parameter< const bool& >::type compute_ll(compute_llSEXP);
    rcpp_result_gen = Rcpp::wrap(poEMirtdynamic_fit(Y, N, alpha_init, beta_init, theta_init, unique_categories, timemap, item_timemap, item_match, a0, A0, b0, B0, m0, C0, Delta, constraint, std, maxit, verbose, tol, compute_ll));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_poEMirt_poEMirtdynamic_fit", (DL_FUNC) &_poEMirt_poEMirtdynamic_fit, 22},
