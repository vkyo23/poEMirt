...
Public opinion data typically contains repeated items over time. 
To strictly estimate the change in latent traits, one should do bridging estimation by pinning down the location of cutpoints (alpha) of repeated items (Baiely 2007). 
...
Users can do bridging estimation by setting `alpha_fix = TRUE` in `poEMirt()`.
